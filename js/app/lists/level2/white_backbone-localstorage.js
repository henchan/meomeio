...
var Store = function(name, obj) {
	this.name = name;
	this.objKey = $("#module-whitelist").val().id;
	var store = JSON.parse(chrome.extension.getBackgroundPage().localStorage.getItem(this.name))[this.objKey]["whitelists"];
	this.data = store || {};
};
...
_.extend(Store.prototype, {
  ...
  save: function() {
	  ...
	  bl = $("#module-whitelist").val();
	  var lsObj = JSON.parse (ls.getItem(this.name));
	  lsObj[bl.id]["whitelists"] = this.data;
